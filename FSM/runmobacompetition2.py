...
obstacles = [[(400, 100), (800, 100), (1100, 400), (1100, 800), (1010, 875), (990, 875), (900, 750), (900, 500), (700, 300), (450, 300), (325, 210), (325, 190)],
			 ...
			 [(540, 350), (560, 370), (520, 410), (500, 390)],
			 [(370, 500), (390, 500), (410, 520), (390, 540), (370, 540), (350, 520)]
			 ]
...
pathnodes = [(720, 480), (450, 670), (440, 410), (160, 160), (780, 780), (1015, 1015), 
...
class HumanHunter(Hunter):
    ...
    def __init__(self, position, orientation, world, image = "sprites/smalltower.gif", speed = SPEED, viewangle = 360, hitpoints = float("inf"), firerate = FIRERATE, bulletclass = BaseBullet):
        Hunter.__init__(self, position, orientation, world, image, speed, viewangle, hitpoints, firerate, bulletclass)

class AlienHunter(Hunter):
...
b1 = Base(BASE, (75, 75), world, 1, MyHumanMinion, HumanHunter)
world.addBase(b1)
...
b2 = Base(BASE, (1125, 1125), world, 2, MyAlienMinion, AlienHunter)
world.addBase(b2)
