...
class HunterBullet(MOBABullet):
	
	def __init__(self, position, orientation, world):
		MOBABullet.__init__(self, position, orientation, world, BASEBULLET, BASEBULLETSPEED, BASEBULLETDAMAGE*100, BASEBULLETRANGE*100)
...
class HumanHunter2(Hunter2):
    
    def __init__(self, position, orientation, world, image = "sprites/smalltower.gif", speed = SPEED, viewangle = 360, hitpoints = float("inf"), firerate = FIRERATE, bulletclass = HunterBullet):
        Hunter2.__init__(self, position, orientation, world, image, speed, viewangle, hitpoints, firerate, bulletclass)

class AlienHunter2(Hunter2):
...
b1 = Base(BASE, (75, 75), world, 1, WanderingHumanMinion, MyHumanHero, HumanHunter2, BUILDRATE, 1000000)
world.addBase(b1)


b2 = Base(BASE, (1125, 1125), world, 2, WanderingAlienMinion, MyAlienHero, AlienHunter2, BUILDRATE, 1000000)
world.addBase(b2)
