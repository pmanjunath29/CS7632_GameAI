...
# I chose to use the uploaded solution code for mybuildpathnetwork.py instead of my own since the provided code is significantly more concise and readable.
# I am crediting the used solution code by link here: https://gatech.instructure.com/courses/314778/files/folder/default_solutions?preview=38940239
